...
class Voix :
    ...
    """
    def __init__(self, vecteur_init, vecteur_rythme, scale, output_port, tempo_def = 120, proba_faux = 0.01) -> None:
        """
...
class VoixGauche (Voix) : 
    ...
    def __init__(self, vecteur_init, vecteur_rythme, scale, output_port, tempo_def=120) -> None:
        super().__init__(vecteur_init, vecteur_rythme, scale, output_port, tempo_def)
...
class VoixEuclideGauche (Voix) : #même objet que voix gauche, mais avec un vecteur de rythme fixe exprimé en bits
    def __init__(self, vecteur_init, vecteur_rythme, scale, output_port, nb_actif, nb_tps, offset, tempo_def=120) -> None:
        super().__init__(vecteur_init, vecteur_rythme, scale, output_port, tempo_def)
