...
class Voix :
    ...
    """
    def __init__(self, vecteur_init, vecteur_rythme, l_tab, scale, output_port, t_origin = time(), tempo_def = 120) -> None:
        """
        on initialise toutes les variables
        """
        self.tempo = tempo_def
        self.oneTime = 60/self.tempo
...
class VoixGauche (Voix) : 
    ...
    def __init__(self, vecteur_init, vecteur_rythme, l_tab, scale, output_port, tempo_def=120) -> None:
        super().__init__(vecteur_init, vecteur_rythme, l_tab, scale, output_port, tempo_def)
...
class VoixEuclideGauche (Voix) : #même objet que voix gauche, mais avec un vecteur de rythme fixe exprimé en bits
    def __init__(self, vecteur_init, vecteur_rythme, l_tab, scale, output_port, nb_actif, nb_tps, offset, t_origin = time(), tempo_def=120) -> None:
        super().__init__(vecteur_init, vecteur_rythme, l_tab, scale, output_port, tempo_def)
